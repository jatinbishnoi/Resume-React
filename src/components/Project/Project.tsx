          ...
          <div className="project">
            <header>
              ...
              <div className="project-links">
                <a href="https://github.com/jatinbishnoi/Messsage-Slack---MERN" target="_blank" rel="noreferrer">
                  <img src={githubIcon} alt="GitHub" />
                </a>
              </div>
            </header>
            <div className="body">
              <h3>Message Slack Website </h3>
              <p>
        ...
        <ScrollAnimation animateIn="flipInX">
          <div className="project">
            <header>
              ...
              <div className="project-links">
                <a href="https://github.com/jatinbishnoi/Instagram-Backend" target="_blank" rel="noreferrer">
        ...
        <ScrollAnimation animateIn="flipInX">
          <div className="project">
            <header>
              <svg width="50" xmlns="http://www.w3.org/2000/svg" role="img" viewBox="0 0 24 24" fill="none" stroke="#23ce6b " strokeWidth="1" strokeLinecap="round" strokeLinejoin="round"><title>Folder</title> <path d="M22 19a2 2 0 0 1-2 2H4a2 2 0 0 1-2-2V5a2 2 0 0 1 2-2h5l2 3h9a2 2 0 0 1 2 2z"></path> </svg>
              <div className="project-links">
                <a href="https://github.com/jatinbishnoi/CoinGecko---CryptoTracker" target="_blank" rel="noreferrer">
                  <img src={githubIcon} alt="Visit site" /> </a>
            ...
            <div className="body">
              <h3>Coin Gecko Crypto Tracker</h3>
              <p>
        ...
        <ScrollAnimation animateIn="flipInX">
          <div className="project">
            <header>
              ...
              <div className="project-links">
                <a href="https://github.com/jatinbishnoi/Food-Restaurant-Backend-API" target="_blank" rel="noreferrer">
        ...
        <ScrollAnimation animateIn="flipInX">
          <div className="project">
            <header>
              ...
              <div className="project-links">
                <a href="https://github.com/jatinbishnoi/AI-ChatBox-VSCode-Extension" target="_blank" rel="noreferrer">
                  <img src={githubIcon} alt="Visit site" />
                </a>
            ...
            <div className="body">
              <h3>AI ChatBot VS Code Extension</h3>
              <p></p>
            </div>
            <footer>
              <ul className="tech-list">
